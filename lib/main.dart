    ...
    return Scaffold(
      ...
      body: ConversationsView(
        onItemTap: (context, ConversationItemModel data) {
          ...
          // if (data is ConversationItemModel) {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) =>
...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _startVoiceCall() async {
    try {
      ...
      String channelName =
          'voice_call_${widget.userId}_${DateTime.now().millisecondsSinceEpoch}';
...
class _VoiceCallScreenState extends State<VoiceCallScreen>
  ...
  void _toggleMute() {
    ...
    widget.agoraManager._engine!.muteLocalAudioStream(_isMuted);
  }
  ...
  void _toggleSpeaker() {
    ...
    widget.agoraManager._engine!.setEnableSpeakerphone(_isSpeakerOn);
  }
