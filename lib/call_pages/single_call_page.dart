...
import 'package:p2p_chat_with_agora_ui_kit/call_pages/call_button.dart';
...
class _SingleCallPageState extends State<SingleCallPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> list = [
      ...
      Positioned.fill(top: 55, bottom: 60, child: content),
    ];

    content = Stack(children: list);

    content = Scaffold(body: content);
    return content;
  }
  ...
  Widget floatWidget() {
    ...
    content = SizedBox(width: 90, height: 160, child: content);
  ...
  Widget audioCallInWidget() {
    ...
    Widget bottom = bottomWidget([answerButton(), hangupButton()]);
  ...
  Widget videoCallWidget() {
    ...
    content = Column(children: [content, const SizedBox(height: 30)]);
          ...
          remoteMute
              ? Positioned(
                  ...
                  child: SizedBox(
                    width: 20,
                    height: 20,
                    child: Icon(Icons.mic_off, size: 20, color: Colors.white),
                  ),
                )
              : const Offstage(),
        ],
  ...
  Widget topWidget(List<Widget> list) {
    Widget content = Column(children: list);
  ...
  Widget cameraButton() {
    return CallButton(
      ...
      selectImage: Icon(Icons.videocam, size: 32, color: Colors.black),
      unselectImage: Icon(Icons.videocam_off, size: 32, color: Colors.black),
  ...
  Widget switchCameraButton() {
    return InkWell(
      ...
      child: Container(
        ...
        child: Icon(Icons.cameraswitch, size: 24, color: Colors.white),
      ),
    );
  }
  ...
  Widget hangupButton() {
    return CallButton(
      ...
      selectImage: Icon(Icons.call_end, size: 32, color: Colors.white),
  ...
  Widget answerButton() {
    return CallButton(
      ...
      selectImage: Icon(Icons.call, size: 32, color: Colors.white),
  ...
  Widget muteButton() {
    return CallButton(
      ...
      selectImage: Icon(Icons.mic_off, size: 32, color: Colors.black),
      unselectImage: Icon(Icons.mic, size: 32, color: Colors.black),
    );
  }
  ...
  Widget speakerButton() {
    return CallButton(
      ...
      selectImage: Icon(Icons.volume_up, size: 32, color: Colors.black),
      unselectImage: Icon(Icons.volume_off, size: 32, color: Colors.black),
    );
  }
